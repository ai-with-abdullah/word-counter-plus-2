...
export default function ReadabilityCalculator() {
  ...
  useSEO({
    ...
    description: 'Check readability with our free calculator tool. Get Flesch Reading Ease, Flesch-Kincaid Grade, Gunning Fog, and SMOG scores. Optimize content now.',
