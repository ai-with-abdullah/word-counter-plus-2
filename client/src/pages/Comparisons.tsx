  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <Card className="bg-primary/5 border-primary/20">
        <CardHeader>
          <CardTitle data-testid="text-why-choose">Why Choose Word Counter Plus?</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid md:grid-cols-3 gap-4 mb-4">
            <div>
              <h3 className="font-semibold mb-2">100% Free Forever</h3>
              <p className="text-sm text-muted-foreground">All premium features including plagiarism detection, SEO analysis, and readability scoring - completely free.</p>
            </div>
            <div>
              <h3 className="font-semibold mb-2">No Ads or Distractions</h3>
              <p className="text-sm text-muted-foreground">Clean, professional interface without advertisements or premium upsells.</p>
            </div>
            <div>
              <h3 className="font-semibold mb-2">Privacy First</h3>
              <p className="text-sm text-muted-foreground">Your text stays private - all analysis happens in your browser with no data storage.</p>
            </div>
          </div>
          <Link href="/">
