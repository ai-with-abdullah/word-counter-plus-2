...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="container mx-auto px-4 pb-12">
        <div className="bg-card rounded-lg p-8 shadow-sm border border-border">
          <h2 className="text-2xl font-bold text-foreground text-center mb-8">Real-World Use Cases & Examples</h2>
            ...
            <div className="space-y-4">
              <div className="text-center">
                <div className="bg-blue-100 dark:bg-blue-900/30 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                  <FaGraduationCap className="text-blue-600 dark:text-blue-400 text-2xl" aria-label="Academic Icon" />
                </div>
                <h3 className="text-lg font-semibold text-foreground mb-3">Essays & Academic Writing</h3>
              </div>
              
              <div className="space-y-3">
                <div className="bg-muted/50 rounded-lg p-4">
                  <h4 className="font-medium text-foreground mb-2">College Essay (500 words)</h4>
                  <p className="text-sm text-muted-foreground mb-2">
                    "Why I chose Computer Science as my major..."
                  </p>
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span>Words: 487/500</span>
                    <span>Reading time: 2 min</span>
                  </div>
                </div>
                
                <div className="bg-muted/50 rounded-lg p-4">
                  <h4 className="font-medium text-foreground mb-2">Research Paper (2,500 words)</h4>
                  <p className="text-sm text-muted-foreground mb-2">
                    "The Impact of AI on Modern Education..."
                  </p>
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span>Words: 2,489/2,500</span>
                    <span>Readability: 65 (Good)</span>
                  </div>
                </div>
                
                <div className="bg-muted/50 rounded-lg p-4">
                  <h4 className="font-medium text-foreground mb-2">Thesis Abstract (250 words)</h4>
                  <p className="text-sm text-muted-foreground mb-2">
                    "This study examines the relationship between..."
                  </p>
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span>Words: 243/250</span>
                    <span>Density: "study" 2.1%</span>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center mt-4">
                <p className="text-xs text-muted-foreground">
                  Perfect for meeting word limits, improving readability, and tracking academic writing progress.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="text-center">
                <div className="bg-purple-100 dark:bg-purple-900/30 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                  <FaPenFancy className="text-purple-600 dark:text-purple-400 text-2xl" aria-label="Social Media Icon" />
                </div>
                <h3 className="text-lg font-semibold text-foreground mb-3">Social Media Content</h3>
              </div>
              
              <div className="space-y-3">
                <div className="bg-muted/50 rounded-lg p-4">
                  <h4 className="font-medium text-foreground mb-2">Twitter/X Post (280 chars)</h4>
                  <p className="text-sm text-muted-foreground mb-2">
                    "Just discovered this amazing word counter tool! 🚀 Perfect for staying within Twitter's character limit..."
                  </p>
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span>Characters: 127/280</span>
                    <span>Words: 21</span>
                  </div>
                </div>
                
                <div className="bg-muted/50 rounded-lg p-4">
                  <h4 className="font-medium text-foreground mb-2">Instagram Caption (2,200 chars)</h4>
                  <p className="text-sm text-muted-foreground mb-2">
                    "Behind the scenes of our latest project! Here's what went into creating this amazing campaign..."
                  </p>
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span>Characters: 1,847/2,200</span>
                    <span>Hashtags: 8</span>
                  </div>
                </div>
                
                <div className="bg-muted/50 rounded-lg p-4">
                  <h4 className="font-medium text-foreground mb-2">LinkedIn Article (1,300 words)</h4>
                  <p className="text-sm text-muted-foreground mb-2">
                    "5 Strategies for Effective Content Marketing in 2025..."
                  </p>
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span>Words: 1,287/1,300</span>
                    <span>Engagement: 7 min read</span>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center mt-4">
                <p className="text-xs text-muted-foreground">
                  Optimize for platform limits, track engagement metrics, and maintain consistent brand voice.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="text-center">
                <div className="bg-green-100 dark:bg-green-900/30 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                  <FaChartLine className="text-green-600 dark:text-green-400 text-2xl" aria-label="Business Icon" />
                </div>
                <h3 className="text-lg font-semibold text-foreground mb-3">Business Documents</h3>
              </div>
              
              <div className="space-y-3">
                <div className="bg-muted/50 rounded-lg p-4">
                  <h4 className="font-medium text-foreground mb-2">Executive Summary (500 words)</h4>
                  <p className="text-sm text-muted-foreground mb-2">
                    "Our Q4 performance shows significant growth across all key metrics..."
                  </p>
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span>Words: 478/500</span>
                    <span>Clarity: Professional</span>
                  </div>
                </div>
                
                <div className="bg-muted/50 rounded-lg p-4">
                  <h4 className="font-medium text-foreground mb-2">Email Newsletter (800 words)</h4>
                  <p className="text-sm text-muted-foreground mb-2">
                    "This month's product updates and company news..."
                  </p>
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span>Words: 789/800</span>
                    <span>Reading time: 3 min</span>
                  </div>
                </div>
                
                <div className="bg-muted/50 rounded-lg p-4">
                  <h4 className="font-medium text-foreground mb-2">Proposal Document (3,000 words)</h4>
                  <p className="text-sm text-muted-foreground mb-2">
                    "Project timeline, deliverables, and budget breakdown..."
                  </p>
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span>Words: 2,847/3,000</span>
                    <span>Keywords: "solution" 1.8%</span>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center mt-4">
                <p className="text-xs text-muted-foreground">
                  Ensure professional tone, meet document requirements, and maintain consistent messaging.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 text-center">
            <div className="bg-gradient-to-r from-primary/10 to-accent/10 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-foreground mb-2">Start Analyzing Your Content Today</h3>
              <p className="text-muted-foreground mb-4">
                Whether you're writing essays, creating social media content, or drafting business documents, 
                our tool provides the insights you need to write better, faster, and more effectively.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <div className="flex items-center text-sm text-muted-foreground">
                  <FaCheckCircle className="text-primary mr-2" aria-label="Check Icon" />
                  Real-time analysis
                </div>
                <div className="flex items-center text-sm text-muted-foreground">
                  <FaCheckCircle className="text-primary mr-2" aria-label="Check Icon" />
